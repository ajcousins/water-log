...
- [x] Save blocked with an error for empty/whitespace labels, labels over 18 chars, duplicate labels (case-sensitive), non-positive/non-integer amounts, or count outside 1–8
